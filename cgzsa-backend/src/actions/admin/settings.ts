...
const Site = z.object({
  ...
  homeHeroImageId: z.string().trim().optional(),
  homeIntroImageId: z.string().trim().optional(),
  homeWasteImageId: z.string().trim().optional(),
  homePublicSpaceImageId: z.string().trim().optional(),
  homeWaterImageId: z.string().trim().optional(),
  homeVolunteerImageId: z.string().trim().optional(),
  homePartnerImageId: z.string().trim().optional(),
  homeDonateImageId: z.string().trim().optional(),
  programsPageImageId: z.string().trim().optional(),
  projectsPageImageId: z.string().trim().optional(),
  newsPageImageId: z.string().trim().optional(),
  eventsPageImageId: z.string().trim().optional(),
  contactPageImageId: z.string().trim().optional(),
});
...
export async function saveSiteSettings(formData: FormData) {
  ...
  await db.update(siteSettings).set({
    ...
    homeHeroImageId: d.homeHeroImageId || null,
    homeIntroImageId: d.homeIntroImageId || null,
    homeWasteImageId: d.homeWasteImageId || null,
    homePublicSpaceImageId: d.homePublicSpaceImageId || null,
    homeWaterImageId: d.homeWaterImageId || null,
    homeVolunteerImageId: d.homeVolunteerImageId || null,
    homePartnerImageId: d.homePartnerImageId || null,
    homeDonateImageId: d.homeDonateImageId || null,
    programsPageImageId: d.programsPageImageId || null,
    projectsPageImageId: d.projectsPageImageId || null,
    newsPageImageId: d.newsPageImageId || null,
    eventsPageImageId: d.eventsPageImageId || null,
    contactPageImageId: d.contactPageImageId || null,
    updatedAt: new Date(),
...
export async function saveAssistantSettings(formData: FormData) {
  const actor = await requireActionPermission("assistant.configure");
