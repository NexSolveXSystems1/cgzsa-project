...
export const metadata = { title: "Organizational Structure" };

export default async function Structure() {
  const team = await db.select().from(teamMembers).where(isNull(teamMembers.deletedAt)).orderBy(asc(teamMembers.order));
  ...
  return (
    <>
      <PageHead crumbs={[["Home", "/"], ["About", "/about"], ["Structure"]]} eyebrow="About CGZSA"
        title="Organizational Structure"
        lede="Select any role to read the duties set out in the CGZSA organizational structure document." />
