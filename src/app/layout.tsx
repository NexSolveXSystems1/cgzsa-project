...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      locale: "en_LR",
      images: [{ url: iconUrl !== "/favicon.svg" ? iconUrl : "/og-default.png", width: 1200, height: 630, alt: s.orgName }],
    },
    twitter: { card: "summary_large_image", images: [iconUrl !== "/favicon.svg" ? iconUrl : "/og-default.png"] },
